 ...
 * </p>
 * <ul>
 *   <li>{@link ImpactProfile.impl.VariabilityModelImpl#getBase_Model <em>Base Model</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariabilityModelImpl extends MinimalEObjectImpl.Container implements VariabilityModel {
	...
	protected EClass eStaticClass() {
		return ImpactProfilePackage.Literals.VARIABILITY_MODEL;
	}
		...
		if (base_Model != null && base_Model.eIsProxy()) {
			...
			if (base_Model != oldBase_Model) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ImpactProfilePackage.VARIABILITY_MODEL__BASE_MODEL, oldBase_Model, base_Model));
			}
		}
		return base_Model;
	}
	...
	public void setBase_Model(Model newBase_Model) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImpactProfilePackage.VARIABILITY_MODEL__BASE_MODEL, oldBase_Model, base_Model));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ImpactProfilePackage.VARIABILITY_MODEL__BASE_MODEL:
